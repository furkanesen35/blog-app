...
const LeftSideBar = () => {
 ...
 return (
  <div className="fixed top-0 bottom-0 bg-gray-1000 text-white w-[725px] flex">
   <div className='flex justify-end w-[725px] '>
    <div className='flex flex-col w-[550px] items-end '>
